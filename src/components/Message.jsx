  ...
  return (
    ...
    >
      <div className={`flex flex-col max-w-[75%]`}>
        {/* Timestamp for Receiver (before bubble) */}
        {!isCurrentUser && firstInGroup && (
        ...
        <div className="relative group">
          <div 
            className={`rounded-2xl px-4 py-2 text-sm ${
              isCurrentUser 
                ? `bg-primary text-primary-content ${firstInGroup ? "rounded-tr-none" : ""}` 
        ...
        {/* Timestamp for Sender (after bubble, aligned right) */}
        {isCurrentUser && firstInGroup && (
...
const ChannelMessage = ({ message, firstInGroup }) => {
  ...
  return (
    ...
    >
      {firstInGroup && (
        <div className="avatar mt-1">
          <div className="w-8 h-8 rounded-full ring-1 ring-base-300">
            <img 
              src={message.userId?.avatar || "https://ui-avatars.com/api/?name=User&background=random"}
      ...
      <div className={`flex flex-col max-w-[75%] ${!firstInGroup ? "ml-10" : ""}`}>
        {firstInGroup && (
          <div className="flex items-center gap-2 mb-1">
        ...
        <div className="relative group">
          ...
          <div className="absolute right-0 top-0 opacity-0 group-hover:opacity-100 transition-opacity flex gap-1">
            <div className="relative">
              ...
              {showEmojiMenu && (
                <div className="absolute bottom-full left-0 mb-2 p-2 bg-base-100 rounded-lg shadow-lg flex gap-1 flex-wrap w-48">
